...
# This route get all existing recipes
...
def add_recipe():
    ...
    #Validate the incoming data to ensure it has the required fields
...
def update_recipe(recipe_id):
    ...
    #Validate the incoming json data to ensure it has the requried fields
    required_fields = ['title', 'ingredients', 'instructions', 'servings', 'description', 'image_url']
